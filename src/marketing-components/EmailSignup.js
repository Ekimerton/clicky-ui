...
import Button from "@/clicky-components/Button/Button";
    ...
    >
      <form onSubmit={handleSubscribe} className="flex gap-2">
        <input
          ...
          className="px-3 py-2 bg-white border border-neutral-200 text-neutral-900 placeholder-neutral-400 w-52 xl:w-42 rounded-none xl:text-sm"
          value={email}
