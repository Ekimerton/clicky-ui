...
export default function Page2() {
  ...
  return (
    <div className="min-h-screen bg-neutral-50">
      <main className="relative pt-8 flex items-center">
        <div className="mx-auto w-full">
          <div className="bg-neutral-100 flex justify-center gap-8 max-w-7xl mx-auto border-gray-200 border-2 p-8 rounded-md">
            {/* Left Section */}
            <div className="flex flex-col gap-12 w-[400px]">
              ...
              <div>
                <h2 className="text-4xl md:text-5xl font-serif mb-4 text-neutral-900 tracking-tight mt-8 text-center">
              ...
              <div
                className={`w-56 h-56 mx-auto relative overflow-hidden rounded-full mt-4 transition-transform duration-200 ${
              ...
              >
                <form className="flex gap-2 w-full">
                  <input
                    ...
                    className="flex-1 px-3 py-2 bg-white border border-neutral-200 text-neutral-900 placeholder-neutral-400 rounded-none"
                  />
